...
-- 7.1 Who receieved a 1.5kg package?
    ...
    select package.weight,client.name from package 
    join client on client.accountnumber = package.recipient where package.weight = 1.5;
    

    
-- 7.2 What is the total weight of all the packages that he sent?

  select sum(package.weight),client.name from package 
    join client on client.accountnumber = package.sender where client.name = "Al Gore's Head";
