...
select employees.name,lastname,departments.name as department_name,departments.budget from employees 
    inner join departments on employees.department = departments.code;

-- 2.12 Select the name and last name of employees working for departments with a budget greater than $60,000.


select employees.name,lastname,departments.budget from employees 
  inner join departments on employees.department = departments.code 
...
join departments on employees.department=departments.code order by budget asc limit 3 ;
...
select budget,(budget-budget*0.10)  as reduce_budget from departments;
